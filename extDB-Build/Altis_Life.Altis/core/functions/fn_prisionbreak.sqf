...
[[4, format["%1 is hacking into the Central Criminal Database to break prisoners out of the jail!", name player]],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
